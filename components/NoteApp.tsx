...
export default function NoteApp({ type = 'main' }: NoteAppProps) {
                ...
                <div className="mb-8 flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-4xl font-bold text-gray-800 mb-2">
                            {type === 'hash' ? 'Secure Hash Notes' : 'Bunny Notes Notepad'}
                        </h1>
                        <p className="text-gray-600">
                            {type === 'hash' ? 'Your private encrypted-like space' : 'Create and manage your notes'}
                        </p>
                    </div>
                </div>
                        ...
                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                            <div className="p-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                                <h3 className="text-lg font-semibold text-gray-700">
                                    {selectedNote ? '编辑笔记 (Edit Note)' : '新笔记 (New Note)'}
                                </h3>
                                <div className="flex gap-2">
                                    ...
                                    <Button
                                        ...
                                        className="px-6"
                                    >
                                        {isLoading ? '保存中...' : selectedNote ? '更新 (Update)' : '保存 (Save)'}
                                    </Button>
                                </div>
                            </div>
                            <div className="p-6">
                                ...
                                <div className="flex justify-end gap-2">
                                    ...
                                    <Button
                                        ...
                                        className="px-8"
                                    >
                                        {isLoading ? '保存中...' : selectedNote ? '更新' : '保存'}
                                    </Button>
                                </div>
                            </div>
                        </div>
